...
class MusicWidget : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.huayin.music.ACTION_PLAY_PAUSE"
        const val ACTION_PREV = "com.huayin.music.ACTION_PREV"
        const val ACTION_NEXT = "com.huayin.music.ACTION_NEXT"
        const val ACTION_SHUFFLE = "com.huayin.music.ACTION_SHUFFLE"
        const val ACTION_LIKE = "com.huayin.music.ACTION_LIKE"
        const val ACTION_REPLAY = "com.huayin.music.ACTION_REPLAY"
        const val ACTION_OPEN_APP = "com.huayin.music.ACTION_OPEN_APP"
        const val ACTION_STATE_CHANGED = "com.huayin.music.ACTION_STATE_CHANGED"
        const val ACTION_UPDATE_PROGRESS = "com.huayin.music.ACTION_UPDATE_PROGRESS"
